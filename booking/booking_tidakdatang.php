...
/* ── Ambil data booking tidak datang ────────────────────────────────────── */
...
$sql_all  = "SELECT * FROM tb_booking $where ORDER BY tanggal_kunjungan DESC";
...
<main class="booking-content" id="bookingContent">
  ...
  <div class="content-inner">
    ...
    <div class="page-title">
      ...
      <p>Daftar booking yang tidak hadir sesuai jadwal</p>
    </div>
    ...
    <div class="card">
      ...
      <div class="table-wrapper">
        <table id="tabelTidakDatang">
          ...
          <tbody>
            ...
            <tr class="empty-row">
              <td colspan="6">Tidak ada data booking tidak datang</td>
            </tr>
      ...
      <div class="table-footer">
        Menampilkan <strong><?php echo count($bookings); ?></strong> data booking tidak datang
      </div>
      <?php endif; ?>
