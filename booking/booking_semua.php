...
$today   = date('Y-m-d');
$sql_all = "SELECT * FROM tb_booking $where ORDER BY
    CASE WHEN tanggal_kunjungan >= '$today' THEN 0 ELSE 1 END ASC,
            ...
            <tr class="data-row">
              ...
              <td>
                <div class="aksi-cell">
                  ...
                  <a href="edit_booking.php?id=<?php echo $row['id']; ?>&ref=booking_semua.php" class="link-edit">Edit</a>
                  <?php endif; ?>
