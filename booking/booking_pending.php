...
if ($search !== '') {
    $where .= " AND (agen_wisata LIKE '%$search%' OR nama LIKE '%$search%' OR pilihan_paket_wisata LIKE '%$search%' OR driver_agent_guide LIKE '%$search%')";
}
...
$sql_all = "SELECT * FROM tb_booking $where ORDER BY tanggal_kunjungan ASC, id DESC LIMIT $per_page OFFSET $offset";
    ...
    <div class="card">
      ...
      <div class="card-header-table">
        <div>
          ...
          <p>Daftar reservasi booking pengunjung yang belum check-in di Desa Candirejo</p>
        </div>
      </div>
      ...
      <form method="GET" action="" id="filterForm">
        <div class="filter-bar">
          ...
          <a href="booking_pending.php" class="btn-reset-filter" title="Reset Filter">
          ...
          <div style="margin-left:auto;">
            <a href="tambah_booking.php?ref=booking_pending.php" class="btn-tambah">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="7" style="text-align:center; padding: 28px 14px; color:#9ab5a8;">
                ...
                <div style="font-size:13px;">Tidak ada data booking pending ditemukan.</div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div class="btn-action-wrap">
                  <!-- Detail -->
                  <a href="detail_booking.php?id=<?php echo $row['id']; ?>&ref=booking_pending.php" class="btn-icon btn-detail" data-tooltip="Lihat Detail" title="Lihat Detail">
                  ...
                  <!-- Edit -->
                  <a href="edit_booking.php?id=<?php echo (int)$row['id']; ?>&ref=booking_pending.php" class="btn-icon btn-edit" data-tooltip="Edit Booking" title="Edit Booking">
      ...
      <div class="table-footer">
        <div>
          Menampilkan <strong><?php echo $total_data > 0 ? ($offset + 1) : 0; ?></strong> - <strong><?php echo min($offset + $per_page, $total_data); ?></strong> dari <strong><?php echo $total_data; ?></strong> data booking pending
        </div>
...
<form id="formAksi" action="proses/proses_checkin.php" method="POST" style="display:none;">
  ...
  <input type="hidden" name="ref" value="booking_pending.php">
</form>
