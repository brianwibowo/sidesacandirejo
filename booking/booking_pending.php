...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-icon-hapus:hover { background: #b71c1c; color: #fff; border-color: #b71c1c; }
    .link-edit {
      color: #3b6fd4; font-size: 13px; font-weight: 500;
      ...
      <div class="table-wrapper">
        <table id="tabelPending">
          ...
          <tbody>
            ...
            <tr class="empty-row">
              <td colspan="7">Tidak ada booking pending saat ini</td>
            </tr>
            ...
            <tr class="data-row">
              ...
              <td>
                <div class="aksi-cell">
                  ...
                  <a href="edit_booking.php?id=<?php echo $row['id']; ?>&ref=booking_pending.php" class="link-edit">Edit</a>
                  <span class="aksi-sep">|</span>
                  <button
                    type="button"
                    class="btn-checkin"
