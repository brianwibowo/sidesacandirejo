    ...
    <div class="card">
      ...
      <div class="card-header-table">
        <div>
          ...
          <p>Daftar reservasi booking pengunjung yang telah berhasil check-in di Desa Candirejo</p>
        </div>
      </div>
      ...
      <form method="GET" action="" id="filterForm">
        <div class="filter-bar">
          ...
          <a href="booking_checkin.php" class="btn-reset-filter" title="Reset Filter">
          ...
          <div style="margin-left:auto;">
            <a href="tambah_booking.php?ref=booking_checkin.php" class="btn-tambah">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="7" style="text-align:center; padding: 28px 14px; color:#9ab5a8;">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" style="margin-bottom:6px; display:inline-block;"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                <div style="font-size:13px;">Tidak ada data booking check-in ditemukan.</div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="badge badge-checkin">Sudah Check-in</span>
              </td>
              <td>
                <div class="btn-action-wrap">
                  <!-- Detail -->
                  <a href="detail_booking.php?id=<?php echo $row['id']; ?>&ref=booking_checkin.php" class="btn-icon btn-detail" data-tooltip="Lihat Detail" title="Lihat Detail">
                  ...
                  <!-- Edit -->
                  <a href="edit_booking.php?id=<?php echo (int)$row['id']; ?>&ref=booking_checkin.php" class="btn-icon btn-edit" data-tooltip="Edit Booking" title="Edit Booking">
      ...
      <div class="table-footer">
        <div>
          Menampilkan <strong><?php echo $total_data > 0 ? ($offset + 1) : 0; ?></strong> - <strong><?php echo min($offset + $per_page, $total_data); ?></strong> dari <strong><?php echo $total_data; ?></strong> data booking check-in
        </div>
...
<form id="formHapus" action="proses/proses_hapus_booking.php" method="POST" style="display:none;">
  ...
  <input type="hidden" name="ref" value="booking_checkin.php">
</form>
