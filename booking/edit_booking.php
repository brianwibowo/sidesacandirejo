...
$ref = isset($_GET['ref']) ? basename($_GET['ref']) : 'booking_dashboard.php';
if (!in_array($ref, $allowed_ref, true)) $ref = 'booking_dashboard.php';
      ...
      <div class="form-card-body">
        <form action="proses/proses_booking.php" method="POST" id="formEdit">
          ...
          <div class="form-row">
            ...
            <textarea name="keterangan" maxlength="500" rows="3" class="form-input" style="resize:vertical;min-height:80px;"
              placeholder="Contoh: 1 orang alergi kacang, minta meja khusus, dll. (opsional)"><?php echo e($bk['keterangan'] ?? ''); ?></textarea>
          </div>
          ...
          <div class="form-actions">
            ...
            <a href="<?php echo e($ref); ?>" class="btn-cancel">Batal</a>
          </div>
