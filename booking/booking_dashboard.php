...
<main class="booking-content" id="bookingContent">
  <div class="content-inner">
    ...
    <?php endif; ?>
      ...
      <p>Ringkasan Booking Hari Ini &mdash; <?php echo date('j') . ' ' . $bulan_id[(int)date('n')-1] . ' ' . date('Y'); ?></p>
    </div>
    ...
    <div class="top-actions">
      ...
      <div class="search-wrap">
        ...
        <input type="text" class="search-input" id="searchInput" placeholder="Cari nama, paket, atau asal..." oninput="updateTable()">
      </div>
    </div>
    ...
    <div class="dashboard-grid">
          ...
          <table id="tabelHariIni">
            ...
            <tbody>
              ...
              <tr class="data-row">
                ...
                <td><?php echo labelPaket($row['pilihan_paket_wisata']); ?></td>
                <td>
      ...
      <div class="tomorrow-card">
        ...
        <div class="tomorrow-item">
          <div class="tomorrow-item-name"><?php echo htmlspecialchars($b['nama']); ?></div>
