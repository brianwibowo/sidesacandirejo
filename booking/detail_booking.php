    ...
    <div class="layout-grid">
      ...
      <div class="stack-panels">
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="info-list">
              ...
              <div class="info-label">Jumlah Wisatawan</div><div class="info-value"><?php echo (int)$bk['pax']; ?> Orang</div>
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="info-list">
              ...
              $paketsWithMakanTour   = ['cycling_tour', 'dokar_tour', 'walking_tour'];
              $paketsWithJenisMakanan = ['meal_only'];
              $paketsWithCooking     = ['cooking_lesson'];
              $paketsWithGamelan     = ['gamelan_class'];
              ?>

              <?php if (in_array($paket, $paketsWithMakanTour)): ?>
                <div class="info-label">Opsi Makan</div>
                <div class="info-value"><?php
                  $val = $bk['opsi_makan_tour'];
                  if ($val === 'with_lunch') echo 'With Lunch';
                  elseif ($val === 'without_lunch') echo 'Without Lunch';
                  else echo displayField($val);
                ?></div>
              <?php endif; ?>

              <?php if (in_array($paket, $paketsWithJenisMakanan)): ?>
                <div class="info-label">Jenis Makanan</div>
                <div class="info-value"><?php
                  $val = $bk['jenis_makanan_paket'];
                  if ($val === 'breakfast') echo 'Breakfast';
                  elseif ($val === 'lunch') echo 'Lunch';
                  elseif ($val === 'dinner') echo 'Dinner';
                  else echo displayField($val);
                ?></div>
              <?php endif; ?>

              <?php if (in_array($paket, $paketsWithCooking)): ?>
                <div class="info-label">Opsi Cooking Lesson</div>
                <div class="info-value"><?php
                  $val = $bk['opsi_cooking_lesson'];
                  if ($val === 'lesson_only') echo 'Lesson Only';
                  elseif ($val === 'lesson_with_tour') echo 'Lesson with Tour';
                  else echo displayField($val);
                ?></div>
              <?php endif; ?>

              <?php if (in_array($paket, $paketsWithGamelan)): ?>
                <div class="info-label">Opsi Gamelan</div>
                <div class="info-value"><?php
                  $val = $bk['opsi_gamelan'];
                  if ($val === 'with_lunch') echo 'With Lunch';
                  elseif ($val === 'without_lunch') echo 'Without Lunch';
        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <?php
              $ket = isset($bk['keterangan']) ? trim((string)$bk['keterangan']) : '';
              if ($ket !== '' && strtolower($ket) !== 'null'):
            ?>
              <div style="font-size:13.5px;color:#1e3a2f;line-height:1.6;white-space:pre-wrap;"><?php echo e($ket); ?></div>
            <?php else: ?>
              <div style="font-size:13px;color:#9ab5a8;font-style:italic;">Tidak ada keterangan.</div>
            <?php endif; ?>
          </div>
        </section>
          ...
          <div class="panel-body">
            <div class="action-list">
              <?php if ($bk['status'] === 'pending'): ?>
                ...
                <a href="edit_booking.php?id=<?php echo (int)$bk['id']; ?>&ref=<?php echo e($ref); ?>" class="btn btn-edit">Edit Data Booking</a>
