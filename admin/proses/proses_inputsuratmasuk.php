...
// ── Upload file surat (PDF / gambar / Word) ────────────────────────────────
...
if (!in_array($orig_ext, $allowed_surat_ext, true) || !in_array($real_mime, $allowed_surat_mime, true)) {
    redirectAlert('../datasuratmasuk.php', 'error', 'Format file tidak didukung. Gunakan PDF, gambar (JPG/PNG/WebP/GIF), atau Word (DOC/DOCX).');
}

$nama_file   = "{$nama_dasar}_{$tanggal_fmt}_{$jam_fmt}.{$orig_ext}";
