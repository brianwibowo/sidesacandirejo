                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        <div style="border: 2px dashed #3498db; border-radius: 8px; padding: 30px 20px; text-align: center; cursor: pointer; background-color: #f8f9fa; transition: all 0.3s ease;" id="upload-area-surat" data-field="file_surat">
                          <div style="font-size: 32px; color: #3498db; margin-bottom: 10px;"><span class="fa fa-cloud-upload"></span></div>
                          <div><strong>Drag file atau klik untuk tambah</strong></div>
                          <small style="color: #7f8c8d;">PDF, Gambar (JPG/PNG/WebP/GIF), atau Word (DOC/DOCX) — 1 file</small>
                        </div>
                        <input name="file_surat"
                          ...
                          type="file" id="file_surat" style="display: none;" autocomplete="off" />
                        ...
                        <small class="text-muted" style="display:block; margin-top: 5px;">Hanya bisa ganti file surat (1 file). Upload file baru jika ingin mengganti file lama. Format: PDF / JPG / PNG / WebP / GIF / DOC / DOCX. (Maks. 10 MB)</small>
                      </div>
                    </div>
                    <div class="form-group">
    ...
    function updatePreview(fieldName, previewContainer) {
      ...
      files.forEach((file, index) => {
        ...
        if (isImage) {
          ...
          fileItemHtml += '<div style="text-align: center; padding: 15px;"><span class="fa fa-file-word-o" style="font-size: 32px; color: #2980b9;"></span>';
          fileItemHtml += '<div style="font-size: 11px; margin-top: 5px; word-break: break-word;">' + file.name.substring(0, 15) + (file.name.length > 15 ? '...' : '') + '</div>';
          fileItemHtml += '<span style="display: inline-block; background: #2980b9; color: white; padding: 3px 6px; border-radius: 3px; font-size: 10px; margin-top: 4px;">WORD</span></div>';
        } else {
