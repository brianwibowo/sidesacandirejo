                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_inputdatapengunjung.php" name="forminputdatapengunjung" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pilihan_paket_wisata">Nama Pemilik<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pilihan_paket_wisata" name="pilihan_paket_wisata" required="required" maxlength="100" placeholder="Masukkan Nama Pemilik" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pilihan_paket_wisata">Nama Usaha<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="pilihan_paket_wisata" name="pilihan_paket_wisata" required="required" maxlength="100" placeholder="Masukkan Nama Usaha" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jenis_wisatawan">Legalitas Usaha<span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
