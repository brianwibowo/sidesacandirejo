  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="center"><?php echo tgl_id($data['tanggal_keluar']); ?></td>
        ...
        <td class="center"><?php echo tgl_id($data['tanggal_kegiatan']); ?></td>
...
$dompdf->render();
$dompdf->stream("laporan_surat_keluar.pdf", ["Attachment" => false]);