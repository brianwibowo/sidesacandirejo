...
<body>
  <h2>Data Surat Keluar &mdash; Desa Candirejo Borobudur</h2>
  <table>
    <thead>
      <tr>
        <th>No</th>
    ...
    <tbody>
      <?php if (mysqli_num_rows($result) > 0): ?>
        ...
        <tr>
          ...
          <td style="text-align:center;"><?php echo tgl_id($row['tanggal_keluar']); ?></td>
          <td><?php echo htmlspecialchars($row['penerima']); ?></td>
          <td><?php echo htmlspecialchars($row['perihal']); ?></td>
          <td><?php echo !empty($row['tempat_acara']) ? htmlspecialchars($row['tempat_acara']) : '-'; ?></td>
          <td style="text-align:center;"><?php echo tgl_id($row['tanggal_kegiatan']); ?></td>
