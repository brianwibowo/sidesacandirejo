                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input name="file_surat"
                          ...
                          type="file" id="file_suratmasuk" class="form-control" />
                        <small class="text-muted"><i class="fa fa-info-circle"></i> Kosongkan jika tidak ingin mengubah file. Format: PDF / JPG / PNG / WebP / GIF / DOC / DOCX. Maks. 10 MB.</small>
                        <?php if (!empty($data['file_surat'])): ?>
                          <?php
                            $ext_lama = strtolower(pathinfo($data['file_surat'], PATHINFO_EXTENSION));
                            $icon_lama = in_array($ext_lama, ['doc','docx']) ? 'fa-file-word-o' : (in_array($ext_lama, ['jpg','jpeg','png','webp','gif']) ? 'fa-file-image-o' : 'fa-file-pdf-o');
                          ?>
                          <br><a href="<?php echo htmlspecialchars('uploads/' . $data['file_surat']); ?>" target="_blank" class="btn btn-xs btn-default">
                            <i class="fa <?php echo $icon_lama; ?>"></i> Lihat File Saat Ini
                          </a>
                        <?php endif; ?>
                      </div>
                    </div>
