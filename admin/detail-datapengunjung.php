            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  $kode_data = mysqli_real_escape_string($db, $_GET['kode_data']);
                  $sql = "SELECT * FROM tb_data_pengunjung WHERE kode_data='$kode_data'";
                      ...
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          <?php if (!empty($data['foto_wisatawan'])): ?>
                            <img class="img-responsive avatar-view" src="../foto_wisatawan/<?php echo $data['foto_wisatawan']; ?>" alt="Avatar">
                          <?php else: ?>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="x_content">
                        ...
                        <div class="text-right">
                          <a href="datapengunjung.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
                        </div>
                      </div>
                    </div>
                  </div>
