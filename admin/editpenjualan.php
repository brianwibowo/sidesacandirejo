                ...
                <div class="x_content">
                  ...
                  <form action="proses/proses_editpenjualan.php" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Kode Data <span
                          class="required">*</span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['kode_data'];?>" type="text" onkeyup="validAngka(this)"
                          id="kode_suratkeluar" name="kode_data" required="required" maxlength="7"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['harga'];?>" type="text" id="kepada_suratkeluar" name="harga"
